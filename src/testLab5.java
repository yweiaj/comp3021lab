...
public class testLab5 {
	public static void main(String args[]) throws Exception{
		...
		t.exportTextToFile("C://Users//ielm//Downloads//");
		String filename="C://Users//ielm//Downloads//"+((TextNote) nb2.getFolders().get(0).getNotes().get(0)).getTitle().replaceAll(" ", "_")+".txt";
		if(new File(filename).exists()){
			System.out.println("TextNote exported in " + new File(filename).getAbsolutePath());
		}else{
			throw new Exception("Your code has some problems.......");
		}
